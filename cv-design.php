                ...
                <div class="row h-100 align-items-center">
                    <div class="col-12">
                        <nav aria-label="breadcrumb" class="breadcumb--con text-center">
                            <h2 class="w-text title wow fadeInUp" data-wow-delay="0.2s">CV Build</h2>
                            <ol class="breadcrumb justify-content-center wow fadeInUp" data-wow-delay="0.4s">
                                <li class="breadcrumb-item"><a href="index.php">Home</a></li>
                                <li class="breadcrumb-item active" aria-current="page">CV Build</li>
                            </ol>
                        </nav>
                    </div>
                </div>
...
<div class="section-heading text-center">
    ...
    <h2 class="wow fadeInUp" data-wow-delay="0.3s">Your CV has been prepared!</h2>
    <p class="wow fadeInUp" data-wow-delay="0.4s">Find the link below to save your cv as pdf.</p>
</div>
...
<div class="section-heading text-center">
    <!-- Dream Dots -->
    <h2 class="wow fadeInUp" data-wow-delay="0.3s">Save Your CV in PDF format!</h2>
...
<script>
    ...
    $(document).ready(function(){
        action = "getcompany";
        skills = <?php echo json_encode($_POST['skills'])?>;
        $.ajax({
    url: "includes/data_operation.php",
    method: "POST",
    data: {action : action, skills: skills},
